...
p = subprocess.Popen(
    ["/usr/bin/git", "pull", "--tags"], stdout=subprocess.PIPE, stderr=subprocess.PIPE
)
...
p = subprocess.Popen(
    ["/usr/bin/git", "tag"], stdout=subprocess.PIPE, stderr=subprocess.PIPE
)
...
p = subprocess.Popen(
    ["ls", REST_Install_Path], stdout=subprocess.PIPE, stderr=subprocess.PIPE
)
