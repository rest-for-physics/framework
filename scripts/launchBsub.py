...
if inputfile == "":
    print(
        "Please specify an input file with commands to execute in lxbatch --input FILE"
    )
    sys.exit(0)
...
for command in lines:
    ...
    while rpt > 0:
        ...
        f.write(
            'export LD_LIBRARY_PATH="/afs/cern.ch/sw/lcg/contrib/gcc/4.8.4/x86_64-slc6-gcc48-opt/lib64:$LD_LIBRARY_PATH"\n'
        )
