# * Finds ROOT instalation This module sets up SQL information It defines:
#   SQL_FOUND          If the ROOT is found SQL_INCLUDE_DIR    PATH to the
#   include directory SQL_LIBRARIES      Libraries required to use SQL
...
if(NOT SQL_CONFIG_EXECUTABLE)
    ...
    if(NOT SQL_VERSION MATCHES "5.5.68")
        execute_process(
        ...
        execute_process(
            COMMAND ${SQL_CONFIG_EXECUTABLE} --cflags
            OUTPUT_VARIABLE SQL_INCLUDE_DIR
            OUTPUT_STRIP_TRAILING_WHITESPACE)
    endif()
