...
/// It is TRestReadoutModule::DoReadoutMapping the responsible to establish
...
/// This class will be used by TRestReadoutModule::FindChannel in order to
...
///////////////////////////////////////////////
/// \brief TRestReadoutMapping destructor
///
TRestReadoutMapping::~TRestReadoutMapping() {}
...
///
Double_t TRestReadoutMapping::GetX(Int_t nodeX) { return (fNetSizeX / fNodesX) * nodeX; }

///////////////////////////////////////////////
/// \brief Gets the Y position of node (i,j)
///
Double_t TRestReadoutMapping::GetY(Int_t nodeY) { return (fNetSizeY / fNodesY) * nodeY; }
...
///
Int_t TRestReadoutMapping::GetChannel(Double_t x, Double_t y) { return fChannel[GetNodeX(x)][GetNodeY(y)]; }

///////////////////////////////////////////////
/// \brief Gets the pixel number corresponding to coordinates (x,y)
///
Int_t TRestReadoutMapping::GetPixel(Double_t x, Double_t y) { return fPixel[GetNodeX(x)][GetNodeY(y)]; }
