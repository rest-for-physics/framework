...
class TRestReadoutModule : public TObject {
 private:
  ...
  Int_t fMininimumDaqId;  ///< The minimum daq channel id associated to the
                          ///< module.
  Int_t
      fMaximumDaqId;  ///< The maximum daq channel id associated to the module.

  std::vector<TRestReadoutChannel>
      fReadoutChannel;  ///< A vector of the instances of TRestReadoutChannel
...
#ifndef __CINT__
  Bool_t
      showWarnings;  //!///< Flag to enable/disable warning outputs. Disabled by
