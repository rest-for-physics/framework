...
//______________________________________________________________________________
TRestDetectorSetup::TRestDetectorSetup(char* cfgFileName, string name)
...
void TRestDetectorSetup::InitFromFileName(TString fName) {
  ...
  fSamplingInMicroSec = (Double_t)strtol(samplingReduced.Data(), NULL, 16) /
                        100.;  // This is only for AGET
