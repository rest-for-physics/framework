...
class TRestGeometry : public TGeoManager {
 protected:
  ...
  Garfield::GeometryRoot*
      fGfGeometry;  //!///< Pointer to Garfield::GeometryRoot object of the
                    //!geometry
  vector<Garfield::ComponentBase*>
      vGfComponent;  //!///< Vector of pointers to Garfield Component object
  vector<Garfield::Sensor*>
      vGfSensor;         //!///< Vector of pointers to Garfield Sensor object
