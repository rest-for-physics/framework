...
public:
    ...
    Int_t GetNumberOfModules() const { int sum=0; for (auto pID : GetPlaneIDs()) for (auto n : GetModuleIDs(pID)) sum += n; return sum;}
    ...
    void SetSpatialObservableX( const std::string &spatialObservableX) { fSpatialObservableX = spatialObservableX;}
    void SetSpatialObservableY( const std::string &spatialObservableY) { fSpatialObservableY = spatialObservableY;}
...
public:
    ...
    class Module {
        ...
        std::vector<TVector2> fRangePeaks = {};//{TVector2(230000, 650000), TVector2(40000, 230000)}; //in development...
        ...
        void AddPeak(const double &energyPeak, const TVector2 &rangePeak=TVector2(0,0)) { 
                    fEnergyPeaks.push_back(energyPeak); fRangePeaks.push_back(rangePeak);}
        ...
        void SetModuleDefinitionCut( const std::string &moduleDefinitionCut) { fDefinitionCut = moduleDefinitionCut;}
        ...
        void SetNumberOfSegmentsX( const Int_t &numberOfSegmentsX) { fNumberOfSegmentsX = numberOfSegmentsX; SetSplitX();}
        void SetNumberOfSegmentsY( const Int_t &numberOfSegmentsY) { fNumberOfSegmentsY = numberOfSegmentsY; SetSplitY();}
        ...
        Module(const TRestCalibrationCorrection& parent, const Int_t planeId, const Int_t moduleId) : p(&parent) {
            SetPlaneId(planeId); SetModuleId(moduleId); };
        ~Module() {};
