...
class TRestGarfieldDriftProcess : public TRestEventProcess {
 ...
 protected:
  ...
  double
      fStopDistance;  ///< Distance from readout to stop electron drift, in mm
