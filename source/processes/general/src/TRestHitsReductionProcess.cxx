...
void TRestHitsReductionProcess::LoadConfig(std::string cfgFilename,
                                           std::string name) {
...
//______________________________________________________________________________
void TRestHitsReductionProcess::BeginOfEventProcess() {
...
TRestEvent* TRestHitsReductionProcess::ProcessEvent(TRestEvent* evInput) {
  ...
  if (this->GetVerboseLevel() == REST_Debug) {
    cout << "TRestHitsReductionProcess : Initial number of hits : "
         << initialHits << endl;
    cout << "TRestHitsReductionProcess : Final number of hits : " << finalHits
         << endl;
  }
