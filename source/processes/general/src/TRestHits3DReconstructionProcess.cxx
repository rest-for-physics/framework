...
///
///             TRestHits3DReconstructionProcess.cxx
///
///             Jan 2016:   First concept (Javier Galan)
///
//////////////////////////////////////////////////////////////////////////

#include "TRestHits3DReconstructionProcess.h"
...
ClassImp(TRestHits3DReconstructionProcess)
    //______________________________________________________________________________
    TRestHits3DReconstructionProcess::TRestHits3DReconstructionProcess() {
    Initialize();
}

//______________________________________________________________________________
TRestHits3DReconstructionProcess::~TRestHits3DReconstructionProcess() { delete fOutputHitsEvent; }
...
int TRestHits3DReconstructionProcess::Ambiguity(const int& n, const int& m) {
    if (n <= 0 || m <= 0) return 0;
    if (n == 1 || m == 1) return 1;
...
int TRestHits3DReconstructionProcess::Factorial(const int& n) {
    int result = n;
    int N = n;
    while (N > 1) result *= (--N);
    return result;
...
//______________________________________________________________________________
void TRestHits3DReconstructionProcess::EndProcess() {
    if (fDraw) {
        delete htemp;
        delete fCanvas;
    }
...
//______________________________________________________________________________
void TRestHits3DReconstructionProcess::InitFromConfigFile() {
