...
Bool_t TRestMultiCoBoAsAdToSignalProcess::InitializeStartTimeStampFromFilename(
    TString fName) {
...
TRestEvent* TRestMultiCoBoAsAdToSignalProcess::ProcessEvent(
    TRestEvent* evInput) {
  ...
  if (GetVerboseLevel() >= REST_Debug) {
    cout << "TRestMultiCoBoAsAdToSignalProcess: Generating event with ID: "
         << fCurrentEvent << endl;
  }
  ...
  if (GetVerboseLevel() >= REST_Debug) {
    cout << "TRestMultiCoBoAsAdToSignalProcess: event time is : " << tSt
         << endl;
    cout << "TRestMultiCoBoAsAdToSignalProcess: "
...
bool TRestMultiCoBoAsAdToSignalProcess::ReadFrameHeader(
...
bool TRestMultiCoBoAsAdToSignalProcess::ReadFrameDataP(FILE* f,
                                                       CoBoHeaderFrame& hdr) {
  unsigned int i;
  int j;
