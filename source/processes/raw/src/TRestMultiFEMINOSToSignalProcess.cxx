...
///             How to use: replace TRestMultiFEMINOSToSignalProcess by your name, 
...
TRestMultiFEMINOSToSignalProcess::TRestMultiFEMINOSToSignalProcess(char *cfgFileName):TRestRawToSignalProcess(cfgFileName)
{
    Initialize();
}
