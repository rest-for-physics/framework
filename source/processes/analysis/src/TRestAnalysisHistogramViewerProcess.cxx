...
void TRestAnalysisHistogramViewerProcess::LoadConfig(std::string cfgFilename,
                                                     std::string name) {
...
void TRestAnalysisHistogramViewerProcess::InitProcess() {
  ...
  fAnaHistoCanvas = new TCanvas(this->GetName(), this->GetTitle(),
                                fHistoCanvasSize.X(), fHistoCanvasSize.Y());
...
//______________________________________________________________________________
TRestEvent* TRestAnalysisHistogramViewerProcess::ProcessEvent(
    TRestEvent* evInput) {
...
void TRestAnalysisHistogramViewerProcess::InitFromConfigFile() {
  ...
  fPlotString =
      GetParameter("plotString", "sAna.TripleMaxIntegral>>(1000,0,1000)");
}
