...
class TiXmlNode : public TiXmlBase {
    ...
    */
    ...
    TiXmlNode* FirstChild(const char* _value) {
        // Call through to the const version - safe since nothing is changed. Exiting syntax: cast this to a
        // const (always safe) call the method, cast the return back to non-const.
...
/**
   ...
   "Child", i ).ToElement(); if ( !child ) break;
        ...
        @verbatim
        TiXmlElement* child = docHandle.FirstChild( "Document" ).FirstChild( "Element" ).FirstChild( "Child"
   ).ToElement();
