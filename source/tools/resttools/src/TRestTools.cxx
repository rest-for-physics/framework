 ...
 public:
  _REST_STARTUP_CHECK() {
    if (getenv("REST_PATH") == NULL) {
      cout << "REST ERROR!! Lacking system env \"REST_PATH\"! Cannot start!"
           << endl;
...
std::vector<TString> TRestTools::GetListOfPathsInEnvVariable(
    TString envVariable) {
...
int TRestTools::ReadASCIITable(TString fName,
