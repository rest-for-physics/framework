...
public:
	...
	virtual DataBaseFileInfo query_fileinfo(int runnumber, int subrun = 0, string filename = "") { return DataBaseFileInfo(); }
	virtual DataBaseFileInfo query_fileinfo(int runnumber, int subrun = 0, int fileid = 0) { return DataBaseFileInfo(); }
