...
class TRestLinearTrack : public TObject {
 ...
 public:
  ...
  Double_t GetMinTransversalDeposit() {
    return fTransversalCharge.GetMinValue();
  }
  Double_t GetMaxTransversalDeposit() {
    return fTransversalCharge.GetMaxValue();
  }
  ...
  void SetMeanPosition(Double_t x, Double_t y, Double_t z) {
    fMeanPosition = TVector3(x, y, z);
  }
