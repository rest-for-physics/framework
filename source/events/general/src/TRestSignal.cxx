...
Double_t TRestSignal::GetIntegralWithThreshold(Int_t from, Int_t to, Double_t baseline,
...
Double_t TRestSignal::GetMaxPeakTime(Int_t from, Int_t to) { return GetTime(GetMaxIndex(from, to)); }
...
void TRestSignal::AddGaussianSignal(Double_t amp, Double_t sigma, Double_t time, Int_t N, Double_t fromTime,
                                    Double_t toTime) {
    for (int i = 0; i < N; i++) {
