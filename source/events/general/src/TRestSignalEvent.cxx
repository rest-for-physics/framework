...
Double_t TRestSignalEvent::GetIntegralWithTime(Double_t startTime,
                                               Double_t endTime) {
  Double_t sum = 0;
...
Double_t TRestSignalEvent::GetIntegralWithThreshold(
...
Double_t TRestSignalEvent::GetBaseLineSigmaAverage(Int_t startBin,
                                                   Int_t endBin) {
...
void TRestSignalEvent::AddChargeToSignal(Int_t sgnlID, Double_t tm,
                                         Double_t chrg) {
