...
class TRestHits : public TObject {
 public:
  ...
  std::vector<Float_t> fZ;  // [fNHits] Position on Z axis for each punctual
                            // deposition (units mm)
  std::vector<Float_t>
      fT;  // [fNHits] Absolute time information for each punctual deposition
           // (units us, 0 is time of decay)
  std::vector<Float_t> fEnergy;  // [fNHits] Energy deposited at each
                                 // 3-coordinate position (units keV)
  std::vector<Short_t>
      fMod;  // [fNHits] Module ID on which each punctual deposition was
             // detected (units us, 0 is time of decay)
  std::vector<Short_t>
      fCh;  // [fNHits] Channel ID on which each punctual deposition was
            // detected (units us, 0 is time of decay)
  ...
  void AddHit(Double_t x, Double_t y, Double_t z, Double_t en, Double_t t = 0,
              Short_t mod = -1, Short_t ch = -1);
  void AddHit(TVector3 pos, Double_t en, Double_t t = 0, Short_t mod = -1,
              Short_t ch = -1);
  ...
  Double_t GetEnergy(int n) {
    return ((Double_t)fEnergy[n]);
  }  // return value in keV

  Bool_t isHitNInsidePrism(Int_t n, TVector3 x0, TVector3 x1, Double_t sizeX,
                           Double_t sizeY, Double_t theta);
  Int_t GetNumberOfHitsInsidePrism(TVector3 x0, TVector3 x1, Double_t sizeX,
                                   Double_t sizeY, Double_t theta);
  Double_t GetEnergyInPrism(TVector3 x0, TVector3 x1, Double_t sizeX,
                            Double_t sizeY, Double_t theta);
  Double_t GetMeanPositionXInPrism(TVector3 x0, TVector3 x1, Double_t sizeX,
                                   Double_t sizeY, Double_t theta);
  Double_t GetMeanPositionYInPrism(TVector3 x0, TVector3 x1, Double_t sizeX,
                                   Double_t sizeY, Double_t theta);
  Double_t GetMeanPositionZInPrism(TVector3 x0, TVector3 x1, Double_t sizeX,
                                   Double_t sizeY, Double_t theta);
  TVector3 GetMeanPositionInPrism(TVector3 x0, TVector3 x1, Double_t sizeX,
                                  Double_t sizeY, Double_t theta);

  Bool_t isHitNInsideCylinder(Int_t n, TVector3 x0, TVector3 x1,
                              Double_t radius);

  Int_t GetNumberOfHitsInsideCylinder(TVector3 x0, TVector3 x1,
                                      Double_t radius);
  ...
  Double_t GetMeanPositionXInCylinder(TVector3 x0, TVector3 x1,
                                      Double_t radius);
  Double_t GetMeanPositionYInCylinder(TVector3 x0, TVector3 x1,
                                      Double_t radius);
  Double_t GetMeanPositionZInCylinder(TVector3 x0, TVector3 x1,
                                      Double_t radius);
  ...
  Bool_t isHitNInsideSphere(Int_t n, Double_t x0, Double_t y0, Double_t z0,
                            Double_t radius);

  Double_t GetEnergyInSphere(TVector3 pos0, Double_t radius);
  Double_t GetEnergyInSphere(Double_t x, Double_t y, Double_t z,
                             Double_t radius);
  ...
  Double_t GetTransversalProjection(TVector3 p0, TVector3 direction,
                                    TVector3 position);
