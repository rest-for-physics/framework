...
class TRestSignal : public TObject {
 ...
 public:
  ...
  Double_t GetIntegralWithThreshold(Int_t from, Int_t to, Int_t startBaseline,
                                    Int_t endBaseline, Double_t threshold = 2,
                                    Int_t nPointsOverThreshold = 5,
                                    Double_t nMinSigmas = 5);
  Double_t GetIntegralWithThreshold(Int_t from, Int_t to, Double_t baseline,
  ...
  Double_t GetBaseLineSigma(Int_t startBin, Int_t endBin,
                            Double_t baseline = 0);
  ...
  void ExponentialConvolution(Double_t fromTime, Double_t decayTime,
                              Double_t offset = 0);
  ...
  void GetSignalGaussianConvolution(TRestSignal* convSgnl,
                                    Double_t sigma = 100., Int_t nSigmas = 5);

  void AddGaussianSignal(Double_t amp, Double_t sigma, Double_t time, Int_t N,
