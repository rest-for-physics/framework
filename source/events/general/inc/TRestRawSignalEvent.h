...
class TRestRawSignalEvent : public TRestEvent {
 ...
 public:
  ...
  Int_t GetLowestWidth(Int_t startBin = 0, Int_t endBin = 0,
                       Double_t minPeakAmplitude = 0);
  Double_t GetLowAverageWidth(Int_t nSignals = 5, Int_t startBin = 0,
                              Int_t endBin = 0, Double_t minPeakAmplitude = 0);
  Double_t GetAverageWidth(Int_t startBin = 0, Int_t endBin = 0,
                           Double_t minPeakAmplitude = 0);
