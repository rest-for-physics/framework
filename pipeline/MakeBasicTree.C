...
Int_t MakeBasicTree(TString inputRunFile, TString outputRootFile = "results.root") {
    cout << "Running 'MakeBasicTree'" << endl;
    TRestRun* run = new TRestRun(inputRunFile.Data());
    ...
    cout << "Finished running 'MakeBasicTree'" << endl;
